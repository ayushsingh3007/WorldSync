...
const addEmployee= async (req, res) => {
  ...
  const attendenceSubmitting=async (req, res) => {
    try {
  ...
  const attendenceSpecificDate= async (req, res) => {
    try {
  ...
  const attendanceReport= async (req, res) => {
    ...
    module.exports= {addEmployee,attendanceReport,attendenceSpecificDate,allEmployees,attendenceSubmitting}